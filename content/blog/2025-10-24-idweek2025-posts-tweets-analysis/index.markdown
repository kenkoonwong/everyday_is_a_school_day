...
Challenging cases! Where we learn from others' experiences. Here is one from `InfectDiseaseAd` about a challenging case of disseminated histoplasmosis in an immunocompetent host. [source](https://bsky.app/profile/InfectDiseaseAd/post/3m3p4j3zjgs2s)le/boghuma.bsky.social/post/3m3n27xikns2o) 
...
All highlighted in green rows are significant after BH correction. You can see on the coefficient column, all are in the negative range, favoring Bluesky. 
